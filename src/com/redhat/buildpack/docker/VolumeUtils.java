...
public class VolumeUtils {
	...
	public static boolean addContentToVolume(DockerClient dc, String volumeName, String pathInVolume, File content) throws IOException {	
		return internalAddContentToVolume(dc, volumeName, ContainerEntry.fromFile("/volumecontent",content));
	}
	
	public static boolean addContentToVolume(DockerClient dc, String volumeName, String name, String content) throws IOException {	
	...
	private static boolean internalAddContentToVolume(DockerClient dc, String volumeName, ContainerEntry...entries ) throws IOException {
